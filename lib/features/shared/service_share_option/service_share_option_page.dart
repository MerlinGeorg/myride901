...
import 'package:myride901/features/shared/service_share_option/service_share_option_bloc.dart';
import 'package:myride901/features/shared/service_share_option/widget/selection_item.dart';

class ServiceShareOptionPage extends StatefulWidget {
  @override
  _ServiceShareOptionPageState createState() => _ServiceShareOptionPageState();
}

class _ServiceShareOptionPageState extends State<ServiceShareOptionPage> {
  final _serviceShareOptionBloc = ServiceShareOptionBloc();
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      if (_arguments['serviceIds'] != null) {
        _serviceShareOptionBloc.serviceIds = _arguments['serviceIds'];
      }
      if (_arguments['vehicleProfile'] != null) {
        _serviceShareOptionBloc.vehicleProfile = _arguments['vehicleProfile'];
      }
      if (_arguments['isShareVehicle'] != null) {
        _serviceShareOptionBloc.isShareVehicle = _arguments['isShareVehicle'];
      }
      setState(() {});
    });
  }
        ...
        builder: (context, snapshot) {
          return Scaffold(
            appBar: AppBar(
              ...
              leading: InkWell(
                onTap: () {
                  _serviceShareOptionBloc.btnBackClicked(context: context);
                },
                child: Padding(
            ...
            body: BlocProvider<ServiceShareOptionBloc>(
