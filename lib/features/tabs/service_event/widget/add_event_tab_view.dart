...
class AddEventTabView extends StatefulWidget {
  ...
  @override
  _AddEventTabViewState createState() => _AddEventTabViewState();
}

class _AddEventTabViewState extends State<AddEventTabView>
    with AutomaticKeepAliveClientMixin<AddEventTabView> {
  List assetList = [];
      ...
      child: Column(
        children: [
          EventDetailAdd(
            ...
            addServiceEventBloc: widget.addServiceEventBloc,
            isAdd: true,
            focus: focus,
          ),
