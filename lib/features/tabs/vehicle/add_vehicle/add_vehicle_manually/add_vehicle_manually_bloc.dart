...
class AddVehicleManuallyBloc extends BlocBase {
  ...
  bool checkValidation() {
    if (Validation.checkIsEmpty(
      ...
      return false;
    } else if (carYearController.text.trim() != '' &&
        (carYearController.text.length != 4 ||
            carYearController.text == '0000' ||
            int.parse(carYearController.text) < 1901)) {
    ...
    if (checkValidation()) {
      AppComponentBase.getInstance()
          ...
          .addVehicle(
              ...
              make_company: carManufacturerController.text,
